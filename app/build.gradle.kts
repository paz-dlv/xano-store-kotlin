...
android { // Bloque principal de configuración Android
    ...
    defaultConfig { // Configuración por defecto del módulo app
        ...
        buildConfigField("String", "XANO_STORE_BASE", "\"https://x8ki-letl-twmt.n7.xano.io/api:EBlppehI/\"") // Base URL Store (Xano)
        buildConfigField("String", "XANO_AUTH_BASE", "\"https://x8ki-letl-twmt.n7.xano.io/api:7ZQJrswK/\"") // Base URL Auth (Xano)
